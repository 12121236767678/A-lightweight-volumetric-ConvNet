...
parser.add_argument('--network', type=str, default='3DLVCN', required=True, help='Network models: {TransBTS, nnFormer, UNETR, SwinUNETR, 3DLVCN}')
...
with torch.no_grad():
    for i, test_data in enumerate(test_loader):
        ...
        # for j, pred_mask in enumerate(test_data['pred']):
        #     image_name = test_samples['images'][i * args.sw_batch_size + j]
        #     save_path = os.path.join(root_dir, "Spleen_02_test.nii.gz")
