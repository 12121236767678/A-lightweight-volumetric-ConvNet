...
def data_loader(args):
    ...
    if args.mode == 'train':
        ...
        valid_img = sorted(glob.glob(os.path.join(root_dir, 'imagesTest', '*.nii.gz')))
        ...
        #test_label = sorted(glob.glob(os.path.join(root_dir, 'labelsTest', '*.nii.gz')))
